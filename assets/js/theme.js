    ...
    ! function(a) { n(6) && n(6).jQuery ? (r = [n(0)], i = a, void 0 !== (o = "function" == typeof i ? i.apply(e, r) : i) && (t.exports = o)) : a(void 0 !== t && t.exports ? n(0) : jQuery) }(function(t) {
        ...
        function n(e, n) {
            ...
            var n = t.extend({}, n),
                ...
                te = null,
                ee = null;
            try { zt.on(kt, O), zt.on(Lt, D) } catch (e) { t.error("events not supported " + kt + "," + Lt + " on jQuery.swipe") }
            this.enable = function() { return this.disable(), zt.on(kt, O), zt.on(Lt, D), zt }, this.disable = function() { return N(), zt }, this.destroy = function() { N(), zt.data(A, null), zt = null }, this.option = function(e, i) {
                    ...
                    value: function(t) {
                        ...
                        if (void 0 !== this.element.parentNode) {
                            ...
                            for (var i in t) {
                                n[i] = {};
                                for (var r in t[i]) {
                                    for (var o = !1, a = 0; a < this.history.length; ++a) { var s = this.history[a]; if (void 0 !== s[i] && !y(s[i][r], t[i][r])) { o = !0; break } }
                                    o || (n[i][r] = !0)
                                }
                            }
